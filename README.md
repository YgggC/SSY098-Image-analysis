...
### 1. [Generative Diffusion Models for 2D Point Clouds](./main.ipynb)
...
*[Insert Chart/Image Here: E.g., GIF or plot showing the reverse diffusion process from Gaussian noise to a clear Swiss Roll point cloud]*

---

### 2. [Deep Learning & Logistic Classification for Cell Imaging](./Learning.ipynb)
...
*[Insert Chart/Image Here: E.g., Confusion matrix of cell classification or Training/Validation Loss curves for the CNN]*

---

### 3. [Robust 3D Reconstruction via Triangulation](./3D-reconstruction.ipynb)
...
*[Insert Chart/Image Here: E.g., 3D scatter plot of the reconstructed point cloud and camera poses]*

---

### 4. [Feature-Based Image Registration & Warping](./Image-registration.ipynb)
...
*[Insert Chart/Image Here: E.g., Visualisation of SIFT keypoint matching between two unaligned images]*

---

### 5. [Automated Image Classification and Defect Detection](./Image-classification-detection.ipynb)
...
*[Insert Chart/Image Here: E.g., Bounding box detection on object test images]*
...
*   **Tools:** Git, Jupyter, Linux, Docker *(add as applicable)*
